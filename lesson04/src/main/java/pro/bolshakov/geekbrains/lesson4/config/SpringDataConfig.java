package pro.bolshakov.geekbrains.lesson4.config;
...
@Configuration
@EnableJpaRepositories("pro.bolshakov.geekbrains.lesson4.repository")
@EnableTransactionManagement
@ComponentScan("pro.bolshakov.geekbrains.lesson4")
public class SpringDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManager() {
        ...
        factory.setPackagesToScan("pro.bolshakov.geekbrains.lesson4.domain");
